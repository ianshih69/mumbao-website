    ...
    <>
      ...
      <main className="bg-[var(--bg-main)] min-h-screen py-16 md:py-24">
        <div className="mx-auto max-w-6xl px-4">
          <h1 className="text-4xl md:text-5xl font-semibold text-[var(--title-main)] mb-8">聯絡我們</h1>
          ...
          <div>
            ...
            <button type="button" className="mt-2 rounded-full px-5 py-2 bg-[var(--accent-main)] text-white shadow-sm border border-[var(--border-main)] hover:opacity-90 transition-opacity">送出</button>
          </form>
        </div>
      </main>
      <Footer />
